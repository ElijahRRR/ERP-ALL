...
> ✅ **冻结已解除（2026-08-01）**。本节三路中：R2-14 14b 已合并（PR #49）、R2-13 的
> 13a/13b/13d 已合并（PR #50）——**剩余在此有效的只有 R2-16**（号段 `0049`–`0050`）。
...
> ✅ **冻结令已解除（2026-08-01）**：R2-17 随 PR #50 合并（真机 D1–D7 全 PASS + Owner 授权），
> R2-18 已落地（PR #51）。单人模式与流程分级自此是全部工单的默认前提。
...
| 序 | 事项 | 性质 | 备注 |
|---|---|---|---|
| **-1** | ~~R2-17 单人模式收口 + R2-18 流程分级~~ | ✅ **已完成**（PR #50/#51，2026-08-01） | 免登录/摘导航/共享 token/人工指派全落；台账翻牌在 PR #53 |
